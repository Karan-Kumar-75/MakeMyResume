...
export function collectFormData() {
  const data = {
    personal: {
      ...
      fatherName: ($('#personal-father') || {}).value || '',
      dob: ($('#personal-dob') || {}).value || '',
      vill: ($('#personal-vill') || {}).value || '',
      po: ($('#personal-po') || {}).value || '',
      ps: ($('#personal-ps') || {}).value || '',
      city: ($('#personal-city') || {}).value || '',
      state: ($('#personal-state') || {}).value || '',
      pincode: ($('#personal-pincode') || {}).value || '',
...
function loadSavedData() {
  ...
  if (data.personal) {
    ...
    const fields = {
      ...
      'personal-father': p.fatherName,
      'personal-dob': p.dob,
      'personal-vill': p.vill,
      'personal-po': p.po,
      'personal-ps': p.ps,
      'personal-city': p.city,
      'personal-state': p.state,
      'personal-pincode': p.pincode,
